            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('注册', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Text('创建您的账号', style: TextStyle(color: Colors.grey[600])),
                  const SizedBox(height: 32),
                  _buildTextField('邮箱', _emailController, keyboardType: TextInputType.emailAddress),
                  const SizedBox(height: 16),
                  _buildTextField('昵称（可选）', _nicknameController),
                  const SizedBox(height: 16),
                  _buildTextField(
                    '密码',
                    _passwordController,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(_loading ? '注册中...' : '注册', style: const TextStyle(fontSize: 16)),
                    ),
                  ),
                  const SizedBox(height: 24),
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: const Text('立即登录', style: TextStyle(color: Color(0xFF2E7D32), fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                  const SizedBox(height: 16),
